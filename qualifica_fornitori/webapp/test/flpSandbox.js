		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Qualifica Fonitori",
									"targetURL": "#qualificafornitoriqualificafornitori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"qualificafornitoriqualificafornitori-display": {
								"semanticObject": "qualificafornitoriqualificafornitori",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=qualificafornitori.qualificafornitori",
									"url": sap.ui.require.toUrl("qualificafornitori/qualificafornitori")
								}
							}
						}
					}
